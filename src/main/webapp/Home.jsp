				...
				<div
					...
					<div class="col p-4 d-flex flex-column position-static">
						...
						<p class="card-text mb-auto">A library management system is
							...
							and the books that are borrowed by members along with their due
							dates..</p>
					</div>
					<div class="col-auto d-none d-lg-block">
						<img width="200" height="250" src="image/im7.png" alt="...">
	...
	<div class="container my-4 order-md-1">
		<div
			...
			<div class="col-md-7 order-md-2">
				...
				<p class="lead">The ultimate goal of the Open Library is to make
					all the published works of humankind available to everyone in the
					world. While large in scope and ambition, this goal is within our
					grasp. Achieving it will require the participation of librarians,
					authors, government officials and technologists.</p>
			</div>
			<div class="col-md-5">
