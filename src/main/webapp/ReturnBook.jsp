...
<body>
	...
	<div class="alert alert-success alert-dismissible">
		<a href="ReturnBook.jsp" class="close" data-dismiss="alert"
	...
	<h1 style="text-align: center; color: green;">There is Data Of
		Book Table For Return Books</h1>
	...
	<sql:query dataSource="${ds}" var="rs">SELECT * FROM issueBooks where sid='<c:out
			value="${getsId}" />' and status='Issued';</sql:query>
	<div class="container">
		<table class="table">
			<tr>
				<td>Image</td>
					...
					<td>
						<form action="returnbook" method="post">
							<input type="hidden" name="id" value="${row.id}" /> <input
								type="hidden" name="bookid" value="${row.bookid}" />
