				...
				<div class="user-details">
					<div class="input-box">
						<span class="details">Role</span> <input type="text" name="role"
							...
							onchange="rolefun()" value="Admin" readonly>
					</div>
					<div class="input-box">
					...
					<div class="input-box">
						<span id="admind" class="details">Name of library</span> <input
							type="text" name="library"
							placeholder="Enter your Name of library" id="admindi2" required>
					</div>
					<div class="input-box">
						<span id="admind2" class="details">Address</span> <input
							type="text" name="add" placeholder="Enter your Adress"
							id="admindi" required>
					</div>
					<div class="input-box">
						<span id="error" class="details">Email</span> <input type="text"
							name="email" placeholder="Enter your Email" id="email"
							oninput="emailcheker()" required>
