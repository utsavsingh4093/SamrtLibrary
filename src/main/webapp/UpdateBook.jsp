	...
	<div class="login-container">
		<div class="login-box">
			...
			<span style="display: flex; flex-direction: row">
				<h2>Update Book</h2> <a href="ViewBook.jsp"><button
				...
				<c:forEach items="${rs.rows}" var="row">
					<div class="input-group">
						<label for="namebook">Name Of Book</label> <input type="text"
							...
							value='<c:out value="${row.BookName}"></c:out>' required>
					</div>
					<div class="input-group">
						<label for="authorname">Author Of Book</label> <input type="text"
							name="author" id="authorname"
							placeholder="Enter Book Author Name"
							value='<c:out value="${row.Author}"></c:out>' required>
					</div>
					<div class="input-group">
						<label for="edition">Edition</label> <input type="text"
							name="edition" id="edition" placeholder="Enter Book Edition"
							value='<c:out value="${row.Edition}"></c:out>' required>
					</div>
					<div class="input-group">
						<label for="quantity">Quantity</label> <input type="text"
							name="quantity" id="quantity" placeholder="Enter Book Quantity"
							value='<c:out value="${row.Quantity}"></c:out>' required>
					</div>
				</c:forEach>
				<br> <br>
